...
namespace CDON
{
	partial class MainForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.geckoWebBrowser3.Size = new System.Drawing.Size(122, 253);
			this.geckoWebBrowser3.TabIndex = 0;
			this.geckoWebBrowser3.Visible = false;
			this.geckoWebBrowser3.Navigating += new Skybound.Gecko.GeckoNavigatingEventHandler(this.GeckoWebBrowser1Navigating);
			// 
			// cListView1
			// 
