...
namespace MediaChrome
{
	partial class ucStore
	{
		...
		private void InitializeComponent()
		{
			...
			this.ucButton3 = new MediaChrome.ucButton();
			this.ucButton4 = new MediaChrome.ucButton();
			this.SuspendLayout();
			// 
			// ucToolbar1
			// 
		...
		private MediaChrome.ucButton ucButton4;
		private MediaChrome.ucButton ucButton3;
		private System.Windows.Forms.TextBox textBox1;
		private MediaChrome.ucButton ucButton2;
