...
namespace MediaChrome
{
    public class CListView : ListView
    {
        ...
        public Dictionary<string, Image> EngineImages;
        ...
        public ListViewItem AddItem(String item)
        {
            ListViewItem D = this.Items.Add(item);
            return D;
        }
        public event EventHandler ScrollEnded;
        public int ScrollX { get; set; }
        public int ScrollY { get; set; }
        public event CListView2.DrawItemX UniDraw;
        public ListViewItem AddItem(ListViewItem item)
        {
            ListViewItem D = this.Items.Add(item);
            if (D.Index % 2 == 1)
                D.BackColor = MainForm.AlternateRowColor();
            D.ImageIndex = 0;
            return D;
        }
    ...
    public class CListView2 : Panel
    {
        ...
        public ListView.SelectedIndexCollection SelectedIndices
        {
            get
            {
                return this.Source.SelectedIndices;
            }
