...
namespace Spofity
{
    ...
    public partial class Form2 : Form
    {
        ...
        public class Feed
        {
            private int recurringRate = 0;
            public int RecurringRate
            {
                get
                {
                        ...
                        if (x == 0 || x == length - 1)
                        {
                            ...
                            if (firstHeadline != currentHeadline)
                            {
                                try
                                {
                                    ...
                                    TimeSpan Exec = DateTime.Now.Subtract(R);
                                    if (this.recurring > 0 && (Exec.Days > 0 || Exec.Hours > 0))
                                        continue;
                                    ...
                                    if ((Diff.TotalMinutes <= 30 && Diff.TotalMinutes >= -30 && !host.bannedSpots.Exists(i => D.URI.ToString() == i) && ((Math.Round(Piff.TotalDays) - Day) == day) || day == -1) || (this.recurring > 0  && Diffx(DateTime.Now.Minute, this.recurring) < 5))
                                    {
        ...
        private SegorifyView currentPage;
        private void goBack()
        {
            if (form1l.Pop()!=null)
            {
        ...
        private Stack<SegorifyView> form1l;
        public Stack<SegorifyView> Form1L
        {
            get
            {
                return form1l;
        ...
        private Stack<SegorifyView> form1r;
        public Stack<SegorifyView> Form1R
        {
            get
            {
                return form1r;
        ...
        {
            InitializeComponent();
            form1l = new Stack<SegorifyView>();
            form1r = new Stack<SegorifyView>();
        ...
        {
            Form3 D = new Form3(Application.UserAppDataPath + "\\feeds.csv");
